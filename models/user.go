...
var UserWhere = struct {
	...
	DepartmentID whereHelpernull_Int
	CreatedAt    whereHelpertime_Time
	UpdatedAt    whereHelpertime_Time
}{
	ID:           whereHelperint{field: "\"user\".\"id\""},
	Name:         whereHelperstring{field: "\"user\".\"name\""},
	DepartmentID: whereHelpernull_Int{field: "\"user\".\"department_id\""},
...
var (
	userAllColumns            = []string{"id", "name", "department_id", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"name", "department_id"}
...
func (o *User) Department(mods ...qm.QueryMod) departmentQuery {
...
func (userL) LoadDepartment(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`department`),
		qm.WhereIn(`department.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) SetDepartment(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Department) error {
	var err error
	if insert {
...
func (o *User) RemoveDepartment(ctx context.Context, exec boil.ContextExecutor, related *Department) error {
	var err error
